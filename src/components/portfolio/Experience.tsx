...
const roles = [
  { company: "Teradyne · LitePoint", role: "Field Application Engineer", years: "2022 – 2024", tag: "RF · Test · Customer" },
  { company: "Qorvo (formerly TriQuint)", role: "Product Development Engineer", years: "2013 – 2022", tag: "Modules · BAW · Ramp" },
  { company: "Dongbu HiTek USA", role: "RF Applications & Bench Verification", years: "2011 – 2012", tag: "Bench · Scripting" },
...
export const Experience = () => (
  <section id="experience" className="py-12 md:py-14 border-t-2 border-rule">
      ...
      <div className="col-span-12 md:col-span-9 md:col-start-4">
          ...
          {roles.map((r, i) => (
            <Reveal key={r.company + r.years} delay={i * 50} as="li">
              <div className="grid grid-cols-12 gap-x-6 py-6 md:py-7 items-baseline">
                <p className="col-span-12 md:col-span-3 font-body text-sm tracking-wide text-ink-soft">
                  {r.years}
                </p>
                <div className="col-span-12 md:col-span-6 mt-1 md:mt-0">
                  <p className="font-display text-lg md:text-xl text-ink leading-tight font-normal">
                    {r.company}
                  </p>
        ...
        <Reveal delay={120} className="mt-12">
          ...
          <p className="mt-3 font-body text-[0.98rem] text-ink-soft leading-relaxed">
            IEEE · Eta Kappa Nu Honor Society (HKN). Volunteer with Junior Achievement USA, Habitat for Humanity, and the Hillsboro School District Curriculum Advisory Committee.
          </p>
        </Reveal>
      </div>
    </div>
